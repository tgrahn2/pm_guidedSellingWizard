(() => {
    ...
    // TJG: config is the output of the "finder.js" config file and ALSO config dataq from the "finder.json" component metadata config file.
    ...
    /**
     * This is the HTML that will appear on the Component editor screen...
     * @param placeholder
     * @param description
     * @param group1
     * @param group2
