...
module.exports.init = function (editor) {
    ...
    editor.configuration.options.put('filters', [
        'Wynstar',
        'Jasper',
        'Joshi',
        'Rainbow',
    ...
    editor.configuration.put(
        'localization', Object.keys(localization).reduce(function (acc, key)
    {
        acc.put(key, Resource.msg(key, 'experience.editors.com.sfcc.finder3', localization[key]));
        return acc;
    }, new HashMap()));
